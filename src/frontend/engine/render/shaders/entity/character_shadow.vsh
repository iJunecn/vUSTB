/**
 * @file character_shadow.vsh
 * @brief 角色方向光阴影顶点着色器
 * 输入：角色顶点、实例模型矩阵、动画参数、皮肤索引、uLightSpaceMatrix
 * 输出：阴影 alpha test 所需的 UV 与纹理层索引
 * 性能：仅对位置做角色局部动画，不输出法线等多余插值
 */

#version 300 es

/* 精度约定：
 * highp 用于光空间变换与角色局部动画
 */
